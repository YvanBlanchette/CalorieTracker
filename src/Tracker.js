...
class CalorieTracker {
  ...
  removeMeal(id) {
    // Get the meal's index from the array and put it in an index variable
    const index = this._meals.findIndex((meal) => meal.id === id);
    // If the meal is not in the array the index will be -1
    if (index !== -1) {
      // Put the meal into a meal variable
  ...
  removeWorkout(id) {
    // Get the workout's index from the array and put it in an index variable
    const index = this._workouts.findIndex((workout) => workout.id === id);
    // If the workout is not in the array the index will be -1
    if (index !== -1) {
      // Put the workout into a workout variable
